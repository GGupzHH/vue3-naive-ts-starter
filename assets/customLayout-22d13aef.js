import{c as be,a as ge,s as fe,b as Z,d as m,e as B,f as pe,g as C,u as V,r as z,h as q,p as re,i as le,j as w,k as G,l as S,N as ne,m as J,n as y,o as F,q as _e,C as me,t as ve,v as K,w as ye,x as ee,y as Ce,z as W,A as T,B as j,D as O,E as D,F as xe,G as Te,H as Se,I as v,J as I,K as h,L as H,M as U,O as se,_ as N,P as ae,Q as L,R as we,S as ke,T as oe,U as Ie,V as ie,W as Be,X as $e,Y as ze,Z as Re,$ as te,a0 as Pe,a1 as Le,a2 as je,a3 as Oe,a4 as Ee,a5 as Me,a6 as He}from"./index-8610761f.js";const Ve=e=>{const{baseColor:o,textColor2:t,bodyColor:r,cardColor:i,dividerColor:l,actionColor:c,scrollbarColor:s,scrollbarColorHover:a,invertedColor:p}=e;return{textColor:t,textColorInverted:"#FFF",color:r,colorEmbedded:c,headerColor:i,headerColorInverted:p,footerColor:c,footerColorInverted:p,headerBorderColor:l,headerBorderColorInverted:p,footerBorderColor:l,footerBorderColorInverted:p,siderBorderColor:l,siderBorderColorInverted:p,siderColor:i,siderColorInverted:p,siderToggleButtonBorder:`1px solid ${l}`,siderToggleButtonColor:o,siderToggleButtonIconColor:t,siderToggleButtonIconColorInverted:t,siderToggleBarColor:Z(r,s),siderToggleBarColorHover:Z(r,a),__invertScrollbar:"true"}},Fe=be({name:"Layout",common:ge,peers:{Scrollbar:fe},self:Ve}),Q=Fe,De=m("layout",`
